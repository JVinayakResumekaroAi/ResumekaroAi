...
const LoginModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center  backdrop-blur-sm z-50 ">
      <div className="relative w-full max-w-[525px] bg-white rounded-[30px] shadow-lg px-8 py-11 ">
          ...
          <div className="relative">
            ...
            {phoneNumber.length > 0 && (
              <button
                ...
                className="absolute right-5 top-[23px] mt-4 cursor-pointer group w-fit  px-6 border-2 bg-blue-500 rounded-full hover:bg-white hover:text-blue-500 text-white  "
              >
                <svg
